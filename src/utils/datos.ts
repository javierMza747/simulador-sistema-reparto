...
export const gruposEtariosCenso2022PorRango: GruposEtariosPorRango = {
  "0-4": new GrupoEtario([0, 4], 1072307, 1392682, 0.00038),
  "5-9": new GrupoEtario([5, 9], 1824234, 1772183, 0.00015),
  "10-14": new GrupoEtario([10, 14], 1842705, 1786201, 0.00022),
  "15-19": new GrupoEtario([15, 19], 1794417, 1764602, 0.00059),
  "20-24": new GrupoEtario([20, 24], 1794417, 1764602, 0.00087),
  "25-29": new GrupoEtario([25, 29], 1729539, 1820852, 0.00097),
  "30-34": new GrupoEtario([30, 34], 1684646, 1784888, 0.00107),
  "35-39": new GrupoEtario([35, 39], 1598863, 1689906, 0.00136),
  "40-44": new GrupoEtario([40, 44], 1603622, 1711533, 0.00193),
  "45-49": new GrupoEtario([45, 49], 1376718, 1486233, 0.00295),
  "50-54": new GrupoEtario([50, 54], 1169613, 1278561, 0.00466),
  "55-59": new GrupoEtario([55, 59], 1038682, 1155449, 0.00745),
  "60-64": new GrupoEtario([60, 64], 923244, 1054462, 0.01196),
  "65-69": new GrupoEtario([65, 69], 790896, 941658, 0.01910),
  "70-74": new GrupoEtario([70, 74], 622529, 793035, 0.03027),
  "75-79": new GrupoEtario([75, 79], 419408, 602502, 0.04772),
  "80-84": new GrupoEtario([80, 84], 241330, 404175, 0.07489),
  "85-95": new GrupoEtario([85, 95], 174517, 383373, 0.18535),
  "95-115": new GrupoEtario([95, 115], 10, 10, 0.40298),
};
