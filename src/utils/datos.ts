...
*/
export const gruposEtariosCenso2022: GrupoEtario[] = [
  new GrupoEtario([0, 4], 1072307, 1392682, 0.00152),
  new GrupoEtario([5, 9], 1824234, 1772183, 0.00073),
  new GrupoEtario([10, 14], 1842705, 1786201, 0.0011),
  new GrupoEtario([15, 19], 1794417, 1764602, 0.00295),
  new GrupoEtario([20, 24], 1794417, 1764602, 0.00435),
  new GrupoEtario([25, 29], 1729539, 1820852, 0.00483),
  new GrupoEtario([30, 34], 1684646, 1784888, 0.00535),
  new GrupoEtario([35, 39], 1598863, 1689906, 0.00679),
  new GrupoEtario([40, 44], 1603622, 1711533, 0.00961),
  new GrupoEtario([45, 49], 1376718, 1486233, 0.01463),
  new GrupoEtario([50, 54], 1169613, 1278561, 0.02303),
  new GrupoEtario([55, 59], 1038682, 1155449, 0.03664),
  new GrupoEtario([60, 64], 923244, 1054462, 0.05818),
  new GrupoEtario([65, 69], 790896, 941658, 0.09139),
  new GrupoEtario([70, 74], 622529, 793035, 0.14122),
  new GrupoEtario([75, 79], 419408, 602502, 0.21402),
  new GrupoEtario([80, 84], 241330, 404175, 0.31597),
  new GrupoEtario([85, 115], 174517, 383373, 0.59167),
];
